...
QC_list <- list(c(1,2))# you can add more days!
# The indexes for the runs on day 1 go from 1 to 4 and from 5 to 8 for day 2!
batch_list <- list(c(1)) #Indicate sample files per batch
...
#Create raw data object for centwave

setwd(path_data_in)
xcms_raw_data <- readMSData(files = datafiles,
