...
source(file = "K:/shares/di04_limet_bioinformatics/PhD Pablo/R_code/TARDIS/R/functions/peakdet.R")
source(file = "K:/shares/di04_limet_bioinformatics/PhD Pablo/R_code/TARDIS/R/functions/quality.R")
source(file = "K:/shares/di04_limet_bioinformatics/PhD Pablo/R_code/TARDIS/R/functions/createRanges.R")
source(file = "K:/shares/di04_limet_bioinformatics/PhD Pablo/R_code/TARDIS/R/functions/createTargetList.R")
source(file = "K:/shares/di04_limet_bioinformatics/PhD Pablo/R_code/TARDIS/R/functions/plotQCs.R")
source(file = "K:/shares/di04_limet_bioinformatics/PhD Pablo/R_code/TARDIS/R/functions/plotSamples.R")
source(file="K:/shares/di04_limet_bioinformatics/PhD Pablo/R_code/TARDIS/R/functions/peaks_with_tardis.R")

start <- Sys.time()

dbData <- createTargetList(input_directory_targets = "C:/Users/Administrator/Desktop/positive/targets.xlsx",pos_pattern = "+",neg_pattern = "-",polarity = 'positive',ion_column = "ion",columns_of_interest = c("id","name","mz","rt"))


result <- tardis_peaks(file_path = "C:/Users/Administrator/Desktop/positive/", dbData = dbData, ppm = 5, rtdev = 18, mode = "metabolomics" , polarity = "positive", output_directory =  "C:/Users/Administrator/Desktop/positive/", plots_samples = TRUE, plots_QC = TRUE, batch_mode = TRUE, batch_positions = list(c(1,149),c(150,294)), sample_pattern = "", QC_pattern = "QC")
