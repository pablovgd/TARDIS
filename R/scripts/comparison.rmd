...
#batch_positions = list(c(1,294))

result <- tardis_peaks(file_path = "D:/Data/Metabease/metabolomics_feces/positive/", dbData = dbData, ppm = 5, rtdev = 12, mode = "metabolomics" , polarity = "positive", output_directory =  "D:/Data/Metabease/metabolomics_feces/positive/", plots_samples = FALSE, plots_QC = FALSE,diagnostic_plots = TRUE, batch_mode = TRUE, batch_positions = batch_positions, sample_pattern = "", QC_pattern = "QC",rt_alignment = TRUE,int_std_id = c("331","1578","1576","1583","1577"))
