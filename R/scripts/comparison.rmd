...
source(file = "R/functions/sumintensities.R")
...
dbData <-
  createTargetList(
    input_directory_targets = "D:/Data/Optim_exploris_kimberly/Lipid/targets_KDW_lipid.xlsx",
    pos_pattern = "+",
    neg_pattern = "-",
    polarity = 'positive',
    ion_column = "ion",
...
batch_positions = list(c(1, 28))
#batch_positions = list(c(1,24),c(25,48))
#batch_positions = list(c(1,263),c(264,612),c(613,681))


#int_std_id_metabease_pos = c("331","1578","1576","1583","1577")
#int_std_id_panic_pos = c("331","1578","1576","1583","1577")
#int_std_id_fame_pos  = c("331","1578","1577","1576","1579")
#int_std_id_fame_neg  = c("1577", "1576", "1579")
#int_std_id_panic_neg  = c("1577", "1576", "1579")
int_std_kimberly_pos <- c("ID331","ID1578","ID1576","ID1583","ID1577")
int_std_kimberly_neg <- c("ID1579")

result <-
  tardis_peaks(
    file_path = "D:/Data/Optim_exploris_kimberly/Lipid/04_Lipid_RSM/positive/",
    dbData = dbData,
    ppm = 5,
    rtdev = 18,
    mode = "lipidomics" ,
    ...
    polarity = "positive",
    output_directory =  "D:/Data/Optim_exploris_kimberly/Lipid/04_Lipid_RSM/positive/",
    plots_samples = FALSE,
    plots_QC = FALSE,
    ...
    QC_pattern = "QC",
    rt_alignment = FALSE,
    int_std_id = int_std_id_panic_pos,
