...
dbData <-
  createTargetList(
    input_directory_targets = "D:/Data/Optim_exploris_kimberly/targets_KDW.xlsx",
    pos_pattern = "+",
    neg_pattern = "-",
    polarity = 'positive',
    ion_column = "ion",
...
result <-
  tardis_peaks(
    file_path = "D:/Data/Optim_exploris_kimberly/positive/",
    dbData = dbData,
    ppm = 5,
    rtdev = 18,
    mode = "metabolomics" ,
    polarity = "positive",
    output_directory =  "D:/Data/Optim_exploris_kimberly/positive/",
    plots_samples = FALSE,
    plots_QC = FALSE,
