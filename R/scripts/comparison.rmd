...
dbData <-
  createTargetList(
    input_directory_targets = "D:/Data/PANIC_saliva/positive/targets.xlsx",
    pos_pattern = "+",
    neg_pattern = "-",
    polarity = 'positive',
    ion_column = "ion",
...
batch_positions = list(c(1, 208), c(209, 416))
...
result <-
  tardis_peaks(
    file_path = "D:/Data/PANIC_saliva/positive/",
    dbData = dbData,
    ppm = 5,
    rtdev = 18,
    mode = "metabolomics" ,
    polarity = "positive",
    output_directory =  "D:/Data/PANIC_saliva/positive/",
    plots_samples = FALSE,
    plots_QC = FALSE,
